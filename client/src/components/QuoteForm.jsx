...
const QuoteForm = () => {
  ...
  const generatePDF = (data, pName) => {
    ...
    doc.text("This document acknowledges your quote request in the Farmliv Enterprise Portal. A formal commercial proposal will be sent within 24 hours.", 105, finalY, { align: 'center', maxWidth: 160 });
