...
const slides = [
    {
        id: 1,
        image: 'https://res.cloudinary.com/dik8mlsie/image/upload/v1773240650/Shadenet8_e3cnqd.webp',
        title: 'Premium B2B Agricultural Solutions',
        subtitle: 'Trusted by Industry Leaders Worldwide'
    },
    {
        id: 2,
        image: 'https://res.cloudinary.com/dik8mlsie/image/upload/v1773240650/Polyfilm6_s6wkut.webp',
        ...
        <div className="relative h-[85vh] sm:h-screen w-full overflow-hidden bg-black contain-layout touch-pan-y pointer-events-auto">
            ...
            <div className="absolute bottom-8 sm:bottom-12 left-1/2 -translate-x-1/2 flex gap-3 sm:gap-4 z-20">
                {slides.map((_, index) => (
                    ...
                    >
                        <div className={`h-1.5 rounded-full transition-all duration-300 ${index === currentSlide ? 'w-10 sm:w-12 bg-white' : 'w-6 sm:w-8 bg-white/40 group-hover:bg-white/60'
                            }`} />
                    </button>
                ))}
            </div>
